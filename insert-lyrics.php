...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-4">
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group text-center">
          ...
          <button type="submit" name="insert" class="btn btn-outline-info">Submit</button>
        </div>
      </form>
      <?php
      if (isset($_POST['insert'])){
        ...
        $insertinto = mysqli_query($conn, "INSERT INTO lyrics
        (title, body, img)
        VALUES ('$title', '$lyrics', '$imgname')");
        if($insertinto){
    ...
    <script>
        CKEDITOR.replace( 'lyrics' ).require;
    </script>
  </body>
</html>