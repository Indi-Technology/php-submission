...
<?php
    ...
    ?>
        <div class="col-sm-3">
            <div class="thumbnail border p-2 rounded">
                <a href="index.php?halaman=artikel&id=<?php echo $data['id_artikel'];?>"><img src="admin/artikel/gambar/<?php echo $data['gambar'];?>" height="200" class="img-fluid"></a>
                <div class="caption">
